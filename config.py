...
AVAIL_LLM_MODELS = ["gpt-4o", "gpt-4o-mini", "gpt-4-turbo"]
...
API_URL_REDIRECT = {"https://api.openai.com/v1/chat/completions":"https://api.baicaiai.com/v1/chat/completions"}
...
# 自定义API KEY格式
CUSTOM_API_KEY_PATTERN = r'^[A-Z0-9]{12}$'
